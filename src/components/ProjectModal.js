...
const ProjectModal = forwardRef(({ project, className, onHidden }, ref) => {
    ...
    function showModal() {
        ...
        const projectLinkBounds = window.document
            .querySelector('.kb-project-gallery__link[href="' + project.hash + '"]')
    ...
    return ReactDOM.createPortal(
        ...
        >
            <div className="kb-project-modal__backdrop" style={backdropPosition}>
                <img
                    className="kb-project-modal__background"
            ...
            <div
                className={
                    'kb-project-modal__content' + (shown ? ' kb-project-modal__content--shown' : '')
                }
            >
                <div className="kb-container kb-position--relative">
                    <button
                        className="kb-project-modal__close fa-solid fa-close"
                        onClick={hideModal}
                    >
                    ...
                    <h2
                        id="project-name"
                        className="kb-project-modal__header kb-text-heading--medium"
                    >
                        {project.name}
                    </h2>
                        ...
                        <ul id="project-details" className="kb-project-modal__detail-list">
                            <li className="kb-project-modal__detail">
                                <p className="kb-text-size--small kb-m-vertical--none">
                                    <strong>Year{project.startYear ? 's' : ''}</strong>
                                </p>
                                <p className="kb-m-vertical--none">
                                    {project.startYear
